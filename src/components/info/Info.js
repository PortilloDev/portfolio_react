    ...
    return (
        <div className="info-container">
            ...
            <div className="spoty-container">
                ...
                <iframe className="spoty" src="https://open.spotify.com/embed/album/7pisJbuy9Ft2hVBoq036qj?utm_source=generator" width="100%" height="auto" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" title="Spoty"></iframe>
            </div>
            <div className="info">
